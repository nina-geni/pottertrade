<?php
    ...
    $results = Article::getAvailableArticles();
    ...
    <div class="banner">
        ...
        <div class="banner-content">
            <div class="banner-text">
                <h1>Welcome</h1>
                <p>This is PotterTrade a site where you can buy and sell Harry Potter related items.</p>
                <p>Join us</p>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="text-picture">
                    <p>Do you have something to sell make an acount!</p>
